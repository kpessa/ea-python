...
PREDEFINED_MED_ORDERS = {
    ...
    'MAG_OX_TAB_400MG_Q12H_2DOSES': {
        ...
        'parse_info': {'dose': 400, 'doseUnit': 'mg', 'numberOfDoses': 2} 
    },
    ...
    'KCL_ERTAB_20MEQ_Q2H_2DOSES': {
        ...
        'parse_info': {'dose': 20, 'doseUnit': 'mEq', 'numberOfDoses': 2} 
    },
    ...
    'KCL_IVPERIPH_10MEQ_Q1H_4DOSES_1HR': {
        ...
        'parse_info': {'dose': 10, 'doseUnit': 'mEq', 'numberOfDoses': 4} 
    },
    ...
    'KCL_ERTAB_20MEQ_Q2H_3DOSES': {
        ...
        'base_med_ref': Meds.kcl_er_tab,
        'parse_info': {'dose': 20, 'doseUnit': 'mEq', 'numberOfDoses': 3} 
    },
    ...
    'KCL_IVPERIPH_10MEQ_Q1H_6DOSES_1HR': {
        ...
        'base_med_ref': Meds.kcl_iv_peripheral,
        'parse_info': {'dose': 10, 'doseUnit': 'mEq', 'numberOfDoses': 6} 
    },
    ...
    'KCL_IVPERIPH_10MEQ_Q1H_2DOSES_1HR': { # Cardiac Only
        ...
        'base_med_ref': Meds.kcl_iv_peripheral,
        'parse_info': {'dose': 10, 'doseUnit': 'mEq', 'numberOfDoses': 2} 
    },
    ...
    'KPHOSNEUT_TAB_2TABS_Q2H_2DOSES': {
        ...
        'parse_info': {'dose': 2, 'doseUnit': 'tab(s)', 'numberOfDoses': 2} 
    },
