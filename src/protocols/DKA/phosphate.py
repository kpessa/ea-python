"""DKA phosphate replacement protocol."""
...
_section_groups: List[SectionGroup] = [
            ...
            },
            {
                ...
                'orders': [
                    {'type': 'timed_lab', 'base_name': 'phos_level', 'minutes': 600, 
                     'comment_base': 'Order a phosphate level 2 hrs after infusion'},
                    {'type': 'timed_lab', 'base_name': 'calcium_ion_serum', 'minutes': 600, 
                     'comment_base': 'Order a calcium level 2 hrs after infusion'},
    ...
    # Group for < 1.0 mg/dL
    {
        ...
        'replacementSection': {
            'criticalAlertText': Text.create_notify_provider_text(1.0, 'mg/dL'),
            'sectionName': '',
...
_initial_labs: List[InitialLabConfig] = [
    {
        'sectionName': 'Phosphate Lab Orders',
